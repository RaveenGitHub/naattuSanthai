...
| Soil Testing                  | Backend + Agronomy       | High     | Medium     | Partially implemented | Soil metric schema, recommendation rules, Tamil output rules      | `D:\Raveendran\naattuSanthai\naattuSanthai\.venv\Scripts\python.exe -m pytest -q tests/test_layered_app.py`                          | [digital_farming/services/soil_health.py](../digital_farming/services/soil_health.py), [digital_farming/api/v1/routes.py](../digital_farming/api/v1/routes.py)                       | Finalize crop/fertilizer/irrigation recommendation engine and Tamil readability checks | 2026-09-05    |
